    ...
    return (
        <>
            <div className="d-flex flex-column flex-shrink-0 p-3 text-white fixed-top min-vh-100 bg-white" style={{ width: "15%" }}>
                ...
                <Link to={"/private/clients"} className="nav-link active" aria-current="page">
                    <button type="button" className="btn w-75 rounded ms-3 admin-navbar-buttons d-flex  align-items-center">
                ...
                <Link to={"/private/pets"} href="#" className="nav-link text-white">
                    <button type="button" className=" btn w-75 rounded ms-3 mt-3 admin-navbar-buttons d-flex align-items-center">
                ...
                <div className="ms-4">
                    <Link to="/">
                    <button type="button" className=" w-75 rounded ms-3 bg-light text-dark" onClick={Logout}>
                        <div>Logout</div>
                    </button>
                    </Link>
                </div>
