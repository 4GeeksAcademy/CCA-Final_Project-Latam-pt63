                    ...
                    <div className="modal-body p-4">
                        <form>
                            <div className="mb-3">
                                ...
                                <select className="form-select" value={newPet.owner_id} onChange={handleChange} name="owner_id">
                                    ...
                                    {clientsDB.map((client, index) => {
                                        ...
                                        return <option key={index} value={client.user_id}>{displayName}</option>;
                                    })}
                                </select>
                            </div>
                            ...
                            <div className="mb-3">
                                ...
                                <input className="form-control" onChange={handleChange} value={newPet.name} name="name">
                                </input>
                            </div>

                            <div className="mb-4">
                                <label className="form-label small text-muted">Type</label>
                                <select className="form-select" value={newPet.pet_type} onChange={handleChange} name="pet_type">
                            ...
                            <div className="mb-4">
                                ...
                                <select className="form-select" value={newPet.breed} onChange={handleChange} name="breed">
                                    <option value="">Select a type</option>
                                    {newPet.pet_type && petBreeds[newPet.pet_type].map((breed, index) => (
                                ...
                                <div className="d-flex gap-2">
                                    ...
                                    <div className="w-50">
                                        <input
                                            ...
                                            value={ageMonths}
                                            onChange={(e) => {
                                                setAgeMonths(e.target.value); setNewPet({
                                                    ...newPet,
                                                    birthdate: birthdateString
                                                })
                                            }}
                            ...
                            <div className="mb-3">
                                ...
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="neutered" id="yesNeutered" value={"true"} onChange={handleChange} />
                                    <label className="form-check-label" htmlFor="yesNeutered">Yes</label>
                                </div>
                                <div className="form-check form-check-inline">
                                    <input className="form-check-input" type="radio" name="neutered" id="noNeutered" value={"false"} onChange={handleChange} />
                            ...
                            <div className="mb-3">
                                ...
                                <input className="form-control" onChange={handleChange} value={newPet.allergies} name="allergies">
                                </input>
                            </div>
