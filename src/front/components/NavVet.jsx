            ...
            <div className="container py-3">
                <div className="d-flex align-items-center justify-content-between">
                    ...
                    <Link to="/" className="text-decoration-none text-dark d-flex align-items-center gap-2">
                     <img src="https://img.freepik.com/vector-gratis/estilo-impresion-patas_78370-7626.jpg" alt="" style={{ width: 44, height: 44, background: "#000" }}/>
                        
                        <div className="lh-sm">
                            <div className="fw-bold" style={{ letterSpacing: 1 }}>VetCare</div>
                    ...
                    <div className="d-flex align-items-center gap-4 ms-auto me-4">
                        ...
                        <Link className="nav-link text-dark p-0" to="/profile">Profile</Link>
                    </div>

                    <button
                        className="btn text-white px-4 py-2 rounded-0" style={{  background: "rgb(48, 130, 114)"}}
