  ...
  return (
    <>
      <div className="container min-vh-100">
        ...
        <div className="row  ps-5 d-flex justify content-center align-content-center">
          <div className="row ms-2 ps-5 d-flex justify-content-center align-content-center">
            <div className="col-6">
