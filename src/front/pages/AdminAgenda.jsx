    ...
    try {
      ...
      if (response.ok) {
        ...
        const formattedData = data.map((appt) => ({
          ...
          doctor_name: appt.doctor_name || "Unassigned"
        }));
        ...
        <div className="d-flex justify-content-between align-items-center mb-4">
          <div>
            ...
            <p className="text-muted">
              Overview for <b>{format(selectedDate, "MMMM do, yyyy")}</b>
            </p>
          </div>
          <button
            className="btn btn-vet text-white px-4 py-2 rounded-3 shadow-sm"
        ...
        <div className="card border-0 shadow-sm rounded-4 mb-4 p-4">
          <div className="d-flex justify-content-between align-items-center mb-4">
            ...
            <div className="d-flex gap-2">
              <button
                className="btn btn-white border btn-sm rounded-pill px-3 shadow-sm"
            ...
            {currentWeek.map((item, index) => {
              ...
              return (
                <div
                  ...
                  className={`p-3 rounded-4 flex-fill cursor-pointer transition-all d-flex flex-column align-items-center justify-content-center ${isSelected
                    ? "bg-vet text-white shadow-lg scale-105"
                ...
                >
                  <small
                    className={`fw-bold text-uppercase mb-1 ${isSelected ? "text-white-50" : "text-secondary"}`}
                  ...
                  {count > 0 ? (
                    <div
                      className={`mt-2 px-2 py-1 rounded-pill small fw-bold ${isSelected ? "bg-white text-vet" : "bg-vet text-white"}`}
                    ...
                    <div
                      className="mt-2 small opacity-50"
        ...
        <div className="card border-0 shadow-sm rounded-4 p-4">
          ...
          {filteredAppointments.length === 0 ? (
            <div className="text-center py-5 text-muted bg-white rounded-4 border border-dashed">
              ...
              <p className="small">
                The doctor's schedule is empty for this date.
              </p>
            </div>
          ) : (
                  ...
                  <div className="row align-items-center">
                    ...
                    <div className="col-md-4">
                      ...
                      <span className="text-muted small">
                        <i className="fa-solid fa-paw me-1 text-vet"></i> Patient:{" "}
                        <b>{cita.pet_name}</b>
                      </span>
                    </div>
                    <div className="col-md-2 text-muted small">
                      <i className="fa-solid fa-user-doctor me-1"></i> {cita.doctor_name} <br />
                    ...
                    <div className="col-md-4 d-flex justify-content-end align-items-center gap-2">
                      ...
                      <span
                        className={`badge rounded-pill px-3 py-2 fw-bold ${cita.status === "Confirmed"
                      ...
                      >
                        Details{" "}
                        <i className="fa-solid fa-chevron-right ms-1 small"></i>
                      </Link>
                    </div>
                  </div>
                </div>
