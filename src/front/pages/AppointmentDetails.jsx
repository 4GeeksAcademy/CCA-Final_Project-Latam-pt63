    ...
    try {
      ...
      if (response.ok) {
        ...
        const previousAppointments = data.history.filter(
          (appt) => appt.appointment_id !== parseInt(appointmentId),
        );
        ...
        <div className="card-body p-4">
          <div className="row text-center text-md-start">
            ...
            <div className="col-md-3">
              ...
              <div className="mt-1">
                <span
                  className={`badge rounded-pill px-3 py-2 ${details.status === "Confirmed" ? "bg-white text-success" : "bg-warning text-dark"}`}
                >
                ...
                <div className="list-group list-group-flush">
                  {history.map((visit, index) => (
                    ...
                    >
                      ...
                      <span
                        className={`badge rounded-pill px-3 ${visit.status === "Confirmed" ? "bg-success-subtle text-success" : "bg-secondary-subtle text-secondary"}`}
                      >
