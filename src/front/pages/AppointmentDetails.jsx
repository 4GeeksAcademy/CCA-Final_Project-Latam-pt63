  ...
  const getDetails = async () => {
    try {
      ...
      const response = await fetch(
        `${backendUrl}/appointment/${appointmentId}`,
        {
  ...
  const getHistory = async (petId) => {
    try {
      ...
      if (response.ok) {
        ...
        const previousAppointments = data.history.filter(
          (appt) => appt.appointment_id !== currentApptId,
        );
  ...
  const handleSaveConsultation = async (medicalData) => {
    try {
      ...
      if (response.ok) {
        ...
        Swal.fire(
          "Session Expired",
          "Please copy your notes before reloading.",
          "warning",
        );
      } else {
    ...
    if (result.isConfirmed) {
      try {
        ...
        if (response.ok) {
          ...
          Swal.fire(
            "Error",
            data.msg || "Could not cancel appointment",
            "error",
          );
        }
      } catch (error) {
            ...
            <div className="row text-center text-md-start">
              <div className="col-md-3 border-end border-white border-opacity-25 mb-3 mb-md-0">
                <small className="opacity-75">
                  <i className="fa-regular fa-calendar me-2"></i>Date & Time
                </small>
                <h5 className="fw-bold m-0 mt-1">
              ...
              <div className="col-md-3 border-end border-white border-opacity-25 mb-3 mb-md-0">
                <small className="opacity-75">
                  <i className="fa-solid fa-stethoscope me-2"></i>Reason
                </small>
              ...
              <div className="col-md-3">
                <small className="opacity-75">
                  <i className="fa-solid fa-circle-info me-2"></i>Status
                </small>
                <div className="mt-1">
                  <span
                    className={`badge rounded-pill px-3 py-2 ${details.status === "Completed" ? "bg-white text-success" : "bg-warning text-dark"}`}
                  >
        ...
        <div className="row g-4">
            ...
            <div className="card border-0 shadow-sm rounded-4 h-100">
              <div className="card-header bg-white border-0 pt-4 px-4">
                <h5 className="fw-bold text-success">
                  <i className="fa-regular fa-user me-2"></i>Client Information
                </h5>
              </div>
              <div className="card-body px-4 pb-4">
                <h4 className="fw-bold mb-3">
                  {details.owner_data
                    ? details.owner_data.first_name +
                      " " +
                      details.owner_data.last_name
                    : "N/A"}
                </h4>
                ...
                <div className="mb-3">
                  ...
                  <span className="fw-medium">
                    {details.owner_data?.address || "Not registered"}
                  </span>
                </div>

                <div
                  className="alert alert-primary border-0 bg-opacity-10 d-flex align-items-center"
                  role="alert"
                >
                  ...
                  <div>
                    ...
                    <small>
                      {details.owner_data?.notes ||
                        "No additional notes available for this client."}
                    </small>
                  </div>
                </div>
              </div>
          ...
          <div className="col-md-6">
            <div className="card border-0 shadow-sm rounded-4 h-100">
              <div className="card-header bg-white border-0 pt-4 px-4">
                <h5 className="fw-bold text-success">
                  <i className="fa-solid fa-paw me-2"></i>Pet Information
                </h5>
              </div>
              <div className="card-body px-4 pb-4">
                  ...
                  <div className="col-6">
                    <div className="p-2 border rounded-3 bg-light">
                      ...
                      <b className="text-danger">
                        {details.pet_data?.allergies || "None"}
                      </b>
                    </div>
                  </div>
                </div>
              ...
              <div className="card border-0 shadow-sm rounded-4 bg-white border-success border-start border-5">
                <div className="card-header bg-white border-0 pt-4 px-4">
                  <h5 className="fw-bold text-dark">
                    <i className="fa-solid fa-file-medical me-2 text-success"></i>
                    Consultation Report
                  </h5>
                </div>
                <div className="card-body px-4 pb-4">
                  <div className="row g-4">
                    <div className="col-md-12">
                      ...
                      <div className="p-3 bg-light rounded-3">
                        {details.anamnesis || (
                          <em className="text-muted">No details recorded.</em>
                        )}
                      </div>
                    </div>
                    <div className="col-md-6">
                    ...
                    <div className="col-12">
                      ...
                      <div className="p-3 bg-light rounded-3">
                        {details.observations || (
                          <em className="text-muted">No observations.</em>
                        )}
                      </div>
                    </div>
                  </div>
            ...
            <div className="card border-0 shadow-sm rounded-4">
              <div className="card-header bg-white border-0 pt-4 px-4 d-flex justify-content-between align-items-center">
                <h5 className="fw-bold text-success mb-0">
                  <i className="fa-solid fa-clock-rotate-left me-2"></i>Recent
                  Visit History
                </h5>
                ...
                {history.length === 0 ? (
                  ...
                  <div className="list-group list-group-flush">
                    {history.map((visit, index) => (
                      <div
                        key={index}
                        className="list-group-item border-0 px-0 py-3 border-bottom d-flex align-items-center justify-content-between"
                      >
                        <div>
                        ...
                        <span
                          className={`badge rounded-pill px-3 ${visit.status === "Completed" ? "bg-secondary-subtle text-secondary" : "bg-success-subtle text-success"}`}
                        >
              ...
              <div className="d-flex gap-3 flex-wrap">
                {details.status !== "Completed" ? (
                  ...
                  <button
                    ...
                    disabled
                  >
                    <i className="fa-solid fa-check me-2"></i>Consultation
                    Finished
                  </button>
                )}
